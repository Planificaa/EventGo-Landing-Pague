document.addEventListener('DOMContentLoaded', function() {
    ...
    function addPageLoader() {
        ...
        loader.innerHTML = `
            <div class="loader-content">
                <img src="https://github.com/Planificaa/EventGo-Landing-Pague/blob/main/public/assets/images/eventgo-logo2.png?raw=true" alt="EventGO Logo" />
    ...
    function showAlert(type) {
        const messages = {
            organizer: 'La función de buscar organizadores está en desarrollo',
            join: 'La función para unirse como organizador está en desarrollo'
        };
